...
export function WalletIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PieChartIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function TargetIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function RepeatIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function BellIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CloudIcon({ className = 'size-6 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function DownloadIcon({ className = 'size-4 shrink-0' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function GithubIcon({ className = 'size-4 shrink-0' }: IconProps) {
  return (
