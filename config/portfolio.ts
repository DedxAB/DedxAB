...
export const portfolioConfig: PortfolioConfig = {
  ...
  hero: {
    ...
    tagline: "Building secure, scalable, and user-focused web products with modern frontend engineering.",
    rotatingLines: [
  ...
  projects: [
    {
      ...
      summary: "A full-stack note sharing application with modern auth and social-style interactions.",
    ...
    },
    {
      ...
      summary: "Single-page movie discovery app with trailers and detailed movie information.",
  ...
  achievements: [
    {
      ...
      description: "Secured runners-up position in Internal Smart Hackathon 2022.",
      year: "2022"
    },
    {
  ...
  contact: {
    ...
    links: [
      { label: "Email", href: "mailto:arnab.officialcorp@gmail.com" }
    ]
  },
  socialLinks: [
  ...
  terminal: {
    ...
    commands: {
      ...
      contact: {
        ...
        output: ["arnab.officialcorp@gmail.com", "LinkedIn and GitHub links are available below."]
      },
      social: {
  ...
  easterEgg: {
    ...
    message: "Developer mode unlocked: precision, speed, and relentless curiosity."
  }
};
