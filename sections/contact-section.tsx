...
export function ContactSection(): React.JSX.Element {
  ...
  const socialStyleMap: Record<string, string> = {
    GitHub:
      'border-slate-500/45 bg-slate-500/10 text-slate-700 dark:text-slate-300 hover:border-slate-400/70',
    LinkedIn:
      'border-blue-500/45 bg-blue-500/10 text-blue-700 dark:text-blue-300 hover:border-blue-400/70',
    X: 'border-cyan-500/45 bg-cyan-500/10 text-cyan-700 dark:text-cyan-300 hover:border-cyan-400/70',
    Instagram:
      'border-pink-500/45 bg-pink-500/10 text-pink-700 dark:text-pink-300 hover:border-pink-400/70',
  };
          ...
          <div className="mt-6 space-y-3">
            {portfolioConfig.contact.links.map((link) => (
              ...
              >
                ...
                <span className="text-xs text-muted-foreground transition-colors group-hover:text-neonCyan">
                  open
                </span>
              </a>
            ))}
